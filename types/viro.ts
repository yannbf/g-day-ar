declare module 'react-viro' {
  ...
  export class ViroAnimatedComponent extends Component<
    ViroAnimatedComponentProps
  > {
    public setNativeProps(nativeProps: any): any;
  }
  ...
  export class ViroDirectionalLight extends Component<
    ViroDirectionalLightProps
  > {
    public setNativeProps(nativeProps: any): any;
  }
  ...
  export class ViroLightingEnvironment extends Component<
    ViroLightingEnvironmentProps
  > {
    public setNativeProps(nativeProps: any): any;
  }
  ...
  export class Viro3DSceneNavigator extends Component<
    Viro3DSceneNavigatorProps
  > {
    public getRandomTag(): any;
    /* Pushes a scene and reference it with the given key if provided.
    If the scene has been previously pushed, we simply show the scene again.
  ...
  export class ViroVRSceneNavigator extends Component<
    ViroVRSceneNavigatorProps
  > {
    public getRandomTag(): any;
    /* Pushes a scene and reference it with the given key if provided.
    If the scene has been previously pushed, we simply show the scene again.
  ...
  export class ViroARSceneNavigator extends Component<
    ViroARSceneNavigatorProps
  > {
    public getRandomTag(): any;
    /* Pushes a scene and reference it with the given key if provided.
    If the scene has been previously pushed, we simply show the scene again.
